...
func (tc *TagCreate) SetTodoID(u uuid.UUID) *TagCreate {
	tc.mutation.SetTodoID(u)
	return tc
}

// SetKeyword sets the "keyword" field.
func (tc *TagCreate) SetKeyword(s string) *TagCreate {
...
func (tc *TagCreate) SetTodo(t *Todo) *TagCreate {
...
func (tc *TagCreate) check() error {
	if _, ok := tc.mutation.TodoID(); !ok {
		return &ValidationError{Name: "todo_id", err: errors.New(`ent: missing required field "Tag.todo_id"`)}
	}
	if _, ok := tc.mutation.Keyword(); !ok {
		return &ValidationError{Name: "keyword", err: errors.New(`ent: missing required field "Tag.keyword"`)}
	}
	...
	if _, ok := tc.mutation.TodoID(); !ok {
		return &ValidationError{Name: "todo", err: errors.New(`ent: missing required edge "Tag.todo"`)}
	}
	return nil
}
