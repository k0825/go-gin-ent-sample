...
// QueryTodo queries the todo edge of a Tag.
func (c *TagClient) QueryTodo(t *Tag) *TodoQuery {
...
// QueryTags queries the tags edge of a Todo.
func (c *TodoClient) QueryTags(t *Todo) *TagQuery {
