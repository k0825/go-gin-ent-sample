...
func (tq *TagQuery) QueryTodo() *TodoQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, tag.TodoTable, tag.TodoColumn),
		)
...
func (tq *TagQuery) WithTodo(opts ...func(*TodoQuery)) *TagQuery {
	query := (&TodoClient{config: tq.config}).Query()
...
func (tq *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := tq.withTodo; query != nil {
		if err := tq.loadTodo(ctx, query, nodes, nil,
			func(n *Tag, e *Todo) { n.Edges.Todo = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TagQuery) loadTodo(ctx context.Context, query *TodoQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Todo)) error {
...
func (tq *TagQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := tq.ctx.Fields; len(fields) > 0 {
		...
		if tq.withTodo != nil {
			_spec.Node.AddColumnOnce(tag.FieldTodoID)
		}
	}
